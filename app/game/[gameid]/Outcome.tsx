  ...
  return (
    <div className="flex w-[80%] md:w-[400px] mt-8 md:mt-12 items-center justify-between">
      <div className={`${gameInPlay && OtoPlay && "opacity-20"} flex items-center`}>
        <div className="theme-piece text-sm md:text-2xl">{gameData.x ? gameData.x : "Waiting..."}</div>
        <div className="theme-piece text-4xl opacity-20 -ml-5 md:-ml-8 md:text-7xl">X</div>
      </div>
      ...
      <div className={`${gameInPlay && XtoPlay && "opacity-20"} flex items-center`}>
        <div className="theme-piece text-4xl opacity-20 -mr-5 md:-mr-8 md:text-7xl">O</div>
        <div className="theme-piece text-sm md:text-2xl">{gameData.o ? gameData.o : "Waiting..."}</div>
      </div>
    </div>
  );
};
